<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="org.json.*,  java.util.*, java.text.SimpleDateFormat, com.jsp.system.Ajax"%>
<!DOCTYPE html>
<html lang="ko">
<head>
<meta charset="UTF-8" />
...
<body>
	...
	<div class="wrap">
		<section class="con1">
			<div>
				<a href="../html/friend.html"><img src="/resources/배너.jpg"
					alt="" /></a>
			</div>
		</section>
		<section class="con2">
			...
			<div class="swiper slide1">
				<ul class="swiper-wrapper">
					...
					<li class="swiper-slide"><img
						src="<%=jsonMovie.getJSONArray("movielist").getJSONObject(keySet.get(i)).getString("poster_path")%>"
						alt="" /></li>
					<%
					}
					%>
		...
		<section class="con3">
			...
			<div class="swiper slide2">
				<ul class="swiper-wrapper">
					...
					%>
					<li class="swiper-slide"><img
						src="<%=jsonMovie.getJSONArray("movielist").getJSONObject(i).getString("poster_path")%>"
						alt="" /></li>
					<%
					}
					%>
	...
	<section class="con5">
		<div class="visited">
			...
			<script language="javascript" type="text/javascript">
				document.write("<font color=white>현재 홈페이지에 <span class='num'>"
						+ hitCt + "</span> 번째 방문자입니다!!"); // 여기 고민해보기
